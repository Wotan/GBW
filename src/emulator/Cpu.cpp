...
int	Emulator::DoOpcode()
{
  ...
  switch (opcode)
    ...
    case 0x09: ADD_16bit(REG_HL, REG_BC); return 8;
    case 0x19: ADD_16bit(REG_HL, REG_DE); return 8;
    ...
    case 0x20:
      mPC += !Z_F ? (SBYTE)ReadMem(mPC) + 1 : 1;
      return 8;
    case 0x28:
      mPC += Z_F ? (SBYTE)ReadMem(mPC) + 1 : 1;
      return 8;
    case 0x30:
      mPC += !C_F ? (SBYTE)ReadMem(mPC) + 1 : 1;
      return 8;
    case 0x38:
      mPC += C_F ? (SBYTE)ReadMem(mPC) + 1 : 1;
      return 8;
    ...
    case 0xC0: if (!Z_F) mPC = Pop(); return 8;
    case 0xC8: if (Z_F) mPC = Pop(); return 8;
    case 0xD0: if (!C_F) mPC = Pop(); return 8;
    case 0xD8: if (C_F) mPC = Pop(); return 8;
...
inline void	Emulator::Halt()
{
  mIsHalted = true;
}

inline void	Emulator::Stop()
{
  mIsStop = true;
}

inline void	Emulator::ToggleInt(bool on)
{
  mMasterIntFlag = on;
}

inline void	Emulator::ToggleIntAfter(bool on)
{
  on = on;
}

inline void	Emulator::Load16bitHL()
{
